...
//フルオートガンの継承元
public abstract class FullAutoGunTest : MonoBehaviour
{
    ...
    [SerializeField, Tooltip("合計弾数(全部で何発持てるか)")] protected int totalAmmo = 216;
    [SerializeField, Tooltip("マガジン弾数(何発でリロードしなかければいけないか)")] int magazineAmmo = 36;

    [SerializeField, Tooltip("拡散半径(ぶれ)")] protected float diffusionR = 30;
