...
public class CircleDiffusionGun : SemiAutoGun
{
    ...
    protected override void Shot()
    {
        ...
        BulletPoolInstantate.Instance.InstBulletRigidbodyMove(bullet, muzzle.position, Quaternion.identity, shotDirection, speed, power);
